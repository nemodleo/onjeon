  ...
  return (
    <>
      ...
      <div className="space-y-1">
        <h3 className="text-base font-bold text-black">세금 계산</h3>
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-semibold text-black text-sm">총 구매액</div>
              <div className="text-xs text-gray-600">면세 한도 내: $ 240 • 한도 초과: $ 180</div>
            </div>
          </div>
          <div className="text-sm font-bold text-black">$ 420</div>
        </div>
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-gray-100 rounded-xl flex items-center justify-center">
            ...
            <div>
              <div className="font-semibold text-black text-sm">납부할 세금</div>
      ...
      {/* Payment Method */}
      <div className="space-y-1">
        <h3 className="text-base font-bold text-black">결제 방법</h3>
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-semibold text-black text-sm">KRW-C 지갑</div>
        ...
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-semibold text-black text-sm">신용카드</div>
      ...
      {/* Process Info */}
      <div className="space-y-1">
        <h3 className="text-base font-bold text-black">제출 후 절차</h3>
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-gray-100 rounded-xl flex items-center justify-center">
              <span className="text-sm">✅</span>
            ...
            <div>
              <div className="font-semibold text-black text-sm">즉시 접수</div>
        ...
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-semibold text-black text-sm">알림 발송</div>
        ...
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-semibold text-black text-sm">공항 통관</div>
