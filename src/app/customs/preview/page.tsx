...
export default function CustomsPreviewPage() {
  return (
    <>
      ...
      {/* Header */}
      <div className="pt-8">
        <h1 className="text-3xl font-bold text-black mb-3">세관 신고서 미리보기</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-50 rounded-2xl p-4">
          <h3 className="font-semibold text-black mb-3">신고서 정보</h3>
          <div className="space-y-2 text-xs">
            ...
            <div className="flex justify-between">
              <span className="text-gray-600">기반 데이터:</span>
              <span className="font-medium">NFT 영수증</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">포함 품목:</span>
              <span className="font-medium">2개 카테고리</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600">신고 형태:</span>
        ...
        {/* 세금 정보 - Apple Style */}
        <div className="bg-gray-50 rounded-2xl p-4">
          <h3 className="font-semibold text-black mb-3">세금 계산</h3>
          <div className="space-y-3">
            <div className="text-center p-3 bg-white rounded-xl">
              <div className="text-xl font-bold text-black">$18</div>
        ...
        {/* 결제 방법 - Apple Style */}
        <div className="bg-gray-50 rounded-2xl p-4">
          <h3 className="font-semibold text-black mb-3">세금 결제</h3>
          <div className="space-y-3">
            ...
            <div className="text-xs text-gray-600 p-2 bg-white rounded-xl">
              KRW-C 결제 시 환율 우대 혜택
            </div>
          </div>
        </div>
        ...
        {/* 제출 후 안내 - Apple Style */}
        <div className="bg-gray-50 rounded-2xl p-4">
          <h3 className="font-semibold text-black mb-3">제출 후 절차</h3>
          <div className="space-y-2 text-xs">
        ...
        {/* 도움말 - Apple Style */}
        <div className="bg-gray-50 rounded-2xl p-4">
          <h3 className="font-semibold text-black mb-3">도움말</h3>
          <div className="space-y-2 text-xs">
            <div>
            ...
            <div className="p-2 bg-white rounded-xl text-gray-600">
