...
import './globals.css'
import { DesktopNavigation } from '@/components/ui/navigation'
              ...
              <div>
                <div className="flex justify-center mb-2">
                  <h2 className="text-3xl relative">
                    ...
                    <span className="text-base font-light text-gray-400 absolute left-full ml-1 bottom-0 whitespace-nowrap">穩錢</span>
                  </h2>
                </div>
                <p className="text-gray-600 text-base mb-4">Global Smart Travel Wallet</p>
              </div>
