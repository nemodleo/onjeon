...
export default function VATRefundDashboardPage() {
  return (
    <>
      ...
      {/* Header */}
      <div className="pt-2">
        <h1 className="text-xl font-bold text-black mb-1">VAT 환급 대시보드</h1>
        <p className="text-gray-600 text-xs">품목별 환급액 • NFT 영수증</p>
      </div>
      ...
      <div className="bg-black rounded-xl p-4 text-white">
        <div className="flex justify-between items-start mb-2">
          <div>
            <p className="text-gray-300 text-xs">예상 VAT 환급액</p>
            <div className="flex items-baseline space-x-1">
              <p className="text-lg font-bold">$ 33.60</p>
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="text-center p-3 bg-white rounded-xl border border-gray-100">
          <div className="text-sm font-bold text-black">대기중</div>
          <div className="text-xs text-gray-600">세관 승인</div>
        </div>
        <div className="text-center p-3 bg-white rounded-xl border border-gray-100">
          <div className="text-sm font-bold text-black">즉시</div>
      ...
      <div className="space-y-1">
        <h3 className="text-base font-bold text-black">환급 방식 비교</h3>
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-semibold text-black text-sm">기존 방식</div>
        ...
        <div className="flex items-center justify-between p-3 bg-white rounded-xl border border-gray-100">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-semibold text-black text-sm">KRW-C 방식</div>
