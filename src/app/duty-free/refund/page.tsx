  ...
  return (
    <>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div>
            <h2 className="text-lg font-bold text-black mb-1">환급 대기 내역</h2>
            <p className="text-gray-600 text-sm">처리 중 • 서류 보완 필요</p>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-base font-semibold text-black">신세계 강남점</div>
                  <div className="text-xs text-gray-600">2시간 전 • 의류</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-base font-semibold text-black">₩35,000</div>
            ...
            <div className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-base font-semibold text-black">롯데백화점 명동점</div>
                  <div className="text-xs text-gray-600">어제 • 화장품</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-base font-semibold text-black">₩18,500</div>
                <div className="text-sm text-blue-600">처리 중</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-base font-semibold text-black">현대백화점 무역센터</div>
                  <div className="text-xs text-gray-600">3일 전 • 전자제품</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-base font-semibold text-black">₩31,500</div>
                <div className="text-sm text-orange-600">서류 보완</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div>
            <h2 className="text-lg font-bold text-black mb-1">최근 환급 완료</h2>
            <p className="text-gray-600 text-sm">완료된 환급 내역</p>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-base font-semibold text-black">갤러리아 명품관</div>
                  <div className="text-xs text-gray-600">1주일 전 • 가방</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-base font-semibold text-green-600">+₩45,000</div>
            ...
            <div className="flex items-center justify-between p-4 bg-white rounded-2xl border border-gray-100">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-base font-semibold text-black">신세계 본점</div>
                  <div className="text-xs text-gray-600">2주일 전 • 화장품</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-base font-semibold text-green-600">+₩28,000</div>
                <div className="text-xs text-gray-600">환급 완료</div>
              </div>
            </div>
          </div>
