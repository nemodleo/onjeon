    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          <span>면세 한도 현황</span>
          <span className="text-base bg-blue-100 text-blue-800 px-2 py-1 rounded">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <span className="text-base text-gray-500">남은 한도</span>
          </div>
        ...
        {usagePercentage > 90 && (
          <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
            <div className="text-red-800 text-base font-medium">⚠️ 한도 초과 위험</div>
        ...
        {usagePercentage > 70 && usagePercentage <= 90 && (
          <div className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            <div className="text-yellow-800 text-base font-medium">⚡ 한도 주의</div>
        ...
        {/* 여행 정보 */}
        <div className="pt-2 border-t space-y-1 text-sm text-gray-500">
...
export function PaymentWarningBanner({ 
  ...
  if (!willExceed) {
    return (
      <div className="p-3 bg-green-50 border border-green-200 rounded-lg mb-4">
        <div className="text-green-800 text-base font-medium">✅ 한도 내 결제</div>
  ...
  return (
    <div className="p-4 bg-red-50 border border-red-200 rounded-lg mb-4">
      <div className="text-red-800 text-base font-medium mb-2">
        ⚠️ 면세 한도 초과 예상
      </div>
