        ...
        {!scannedData ? (
          <>
            <div className="text-center py-8">
              ...
              <div className="text-xl font-semibold mb-2">QR 코드를 스캔하세요</div>
          ...
          <>
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="text-base font-medium text-green-800">QR 스캔 완료</span>
                <span className="text-sm text-gray-500">ID: {scannedData.paymentId}</span>
              </div>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <div className="text-base text-gray-600 mb-1">결제 요청 금액</div>
              <div className="text-3xl font-bold">
            ...
            {quote && (
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="text-base font-medium text-blue-800 mb-2">정산 정보</div>
